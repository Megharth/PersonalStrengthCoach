...
- **Entry point**: `PersonalStrengthCoachApp.swift` builds the single `ModelContainer` from `Schema(AppSchemaV6.models)` and `AppMigrationPlan`, and forces dark mode.
